...
const initialBooks: Book[] = [
  ...
  },
  {
    ...
    genre: 'Classic',
    description: 'The story of a young girl confronting racial injustice in a small Southern town during the Great Depression as she observes her father, a lawyer, defend a Black man falsely accused of a terrible crime.',
    reviews: [
      {
        id: '102',
        userName: 'LiteraryFan',
        rating: 5,
        comment: 'One of the most impactful novels about social justice ever written.',
        date: '2023-05-20'
      }
    ]
  },
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment: 'Eerily prescient in many ways. A must-read for understanding modern surveillance issues.',
        date: '2023-03-10'
      }
    ]
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: 'The perfect gateway into fantasy literature. Tolkien\'s world-building is unmatched.',
        date: '2023-01-05'
      }
    ]
  },
  {
    ...
    description: 'The leading textbook in Artificial Intelligence, used in over 1500 universities. It provides a comprehensive overview of the field, from machine learning to robotics, computer vision, and natural language processing.',
    reviews: [
      {
        id: '105',
        userName: 'AIResearcher',
        rating: 5,
        comment: 'The definitive AI textbook. Comprehensive, well-structured, and accessible to both beginners and experts.',
        date: '2023-06-12'
      }
    ]
  },
    ...
    reviews: [
      {
        ...
        userName: 'MLEngineer',
        rating: 5,
        comment: 'Essential reading for anyone serious about deep learning. The best balance of theory and practical insights available.',
        date: '2023-07-18'
      }
    ]
  },
  {
    ...
    genre: 'Computer Science',
    description: 'An essential roadmap to our present and our future, The Age of AI explores how AI is challenging the very essence of what it means to be human, transforming our societies, our politics, and our lives.',
    reviews: [
      {
        id: '107',
        userName: 'FutureThinker',
        rating: 4,
        comment: 'A thoughtful analysis of AI\'s societal implications, written from a policy and strategic perspective rather than a technical one.',
        date: '2023-09-02'
      }
    ]
  },
  {
    ...
    genre: 'Computer Science',
    description: 'In the popular imagination, AI systems are racing toward superintelligence, humans will be overtaken, and a sci-fi dystopia will follow. Russell argues that this scenario can be avoided by building AI systems that are provably aligned with human values.',
    reviews: [
      {
        id: '108',
        userName: 'AIEthicist',
        rating: 5,
        comment: 'A profound book that tackles the existential questions of AI with clarity and depth. Essential reading for understanding AI safety.',
        date: '2023-05-14'
      }
    ]
  }
